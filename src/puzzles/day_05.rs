...
mod part_one {
    ...
    mod tests {
        ...
        #[test]
        fn part_one() {
            if let Ok(lowest_location) = solve(INPUT) {
...
mod parser {
    use std::{iter::Iterator, ops::Range, str::Chars};
    ...
    #[cfg(test)]
    mod tests {
        use super::{super::INPUT, parse, Almanac, ComponentMap, HasNumbers, RangeMap, SeedMode};
